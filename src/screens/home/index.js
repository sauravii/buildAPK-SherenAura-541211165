...
import IconLikes from "../../assets/icons/ic-likes.svg";
import IconLikesActive from "../../assets/icons/ic-likes-active.svg";
      ...
      <ScrollView>
        <View style={styles.container}>
          <View style={{ alignItems: "center" }}>
            ...
            <ButtonMain checkPrimaryCondition={true} btnStyle={styles.btnPrimary} title="Contact me" textStyle={styles.txtBtnPrimary} onPress={() => alert("Hello")} />
          </View>
